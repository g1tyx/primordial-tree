...
var cnItems = {
    ...
    "Implemented Earth layer": "实施的土层",
    "Implemented Flame, Life, & Water layers": "实施火焰、生命和水层",
    "Implemented Intrabonds": "实施分子间力",
    ...
    "Air Particles": "空气粒子",
    "Disable the Flame layer, Life buyable costs are raised ^2.50, and Aqua Particle base cost is raised ^2.20 and cannot get below 1": "禁用火焰层，生命可购买成本提高 ^2.50，水粒子基础成本提高 ^2.20，且不能低于 1",
    ...
    "Flame, Life, and Aqua Particle gain is tripled for the first": "火焰、生命和水粒子增益增加三倍在每轮游戏的前",
    ...
    "Ultrasound boosts Life Buyable Power at a reduced rate.": "超声波以较低的速度提升 生命可购买效果。",
    ...
    "Zephyr:": "西风：",
    "Divide the Earth Grid Cost based on Combinators.": "根据组合器划分土电网成本。",
    "Duration": "期间",
    "Earth Particles": "土粒子",
    "Earth, Lightning, Air, and Cryo Particles by": "土、闪电、空气和低温粒子",
    "Energy": "能量",
    "Fill Grid": "填充网格",
    ...
    "Increase Life Buyable Power based on Combinators.": "基于组合器增加生命可购买效果。",
    "Indigo": "靛青",
    "Indigo Energy": "靛蓝能源",
    ...
    "Levels up the Earth Grid, but resets it. Requires all grid cells filled.": "升级土网格，但重置它。需要填充所有网格单元格。",
    "Life Buyable 6 Effect Mult:": "生命可购买 6 效果倍增：",
    "Light Particles": "光粒子",
    "Location": "地点",
    "Magma Molecule": "岩浆分子",
    ...
    "Mud Molecule": "泥分子",
    "Multiplies": "相乘",
    "Multiply Particle & Aqua Particle gain based on Earth Particles.": "基于土粒子的粒子和水粒子增益。",
    "Ocean Nigh": "海洋之夜",
    "Orange": "橙色",
    "Orange Energy": "橙色能量",
    ...
    "Automatically level up and fill the Earth Grid if both are possible every second, and double Ultrasound gain.": "如果每秒都可能，则自动升级并填充土网格，并加倍超声波增益。",
    ...
    "Gain 100% of Earth Particle gain every second.": "每秒获得 100% 的土粒子增益。",
    ...
    "Unlock Earth, and all Aqua Bars are twice as fast.": "解锁土，所有 水进度条 的速度都提高了一倍。",
    ...
    "Wind/Zephyr/Tornado Speeds work sublinearly (square root) rather than logarithmically, and Aqua Bars are faster based on your Earth Grid Level (": "风/西风/龙卷风 速度以次线性（平方根）而非对数方式工作，并且 水进度条 根据您的土网格级别更快（",
    "x)": "X）",
    "You can activate two Lightning Modes at once.": "您可以一次激活两种闪电模式。",
    "You can fill the Earth Grid with a single button.": "您可以用一个按钮填充土网格。",
    "You can max all Molecules at once.": "您可以一次最大化所有分子。",
    "Particle Combinator Effect": "粒子组合器效果",
    "Cosmic Wonders": "宇宙奇观",
    "Deathly Plunders": "死亡掠夺",
    "Generate Violet Energy over time based on Attraction Power.": "根据吸引力随时间产生紫色能量。",
    "Makes Covalent Bonds 150.00% stronger.": "使共价键强 150.00%。",
    "Makes Ionic Bonds 100.00% stronger.": "使离子键强 100.00%。",
    "Makes Metallic Bonds 100.00% stronger.": "使金属键强度提高 100.00%。",
    "Torn Asunder": "撕裂",
    "Violet Energy": "紫色能量",
    "Violet Energy Boost": "紫色能量提升",
    "Violet Energy boosts Indigo Energy gain at a reduced rate.": "紫色能量以降低的速率提高靛蓝能量增益。",
    "Violet Energy extends the length of all Color Energy boosts.": "紫色能量延长了所有颜色能量提升的长度。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Triples all Color Energy gain for 1m (.+), but sacrifices all Light Particles.$/, '在 $1 内将所有颜色能量增益增加三倍，但会牺牲所有光粒子。'],
    [/^Triples Blue Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 蓝色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Green Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 绿色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Red Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 红色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Violet Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 紫色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Indigo Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 靛青色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Yellow Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 黄色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Triples Orange Energy gain for (.+), but sacrifices (.+) Light Particles.$/, '在 $1 内将 橙色 能量增益增加三倍，但会牺牲 $2 光粒子。'],
    [/^Last played (.+)$/, '最近游戏 $1'],
